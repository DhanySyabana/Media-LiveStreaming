...
class BeritaSatu:
    ...
    def GetSegment(self) -> list:
        file_segments = []
        logging.info(F"Playlist URI: {self.host_directory}/{self.playlist}")
...
if __name__ == "__main__":
    ...
    BeritaSatu = BeritaSatu(
        ...
        converter_host=CONFIG.SOCKET_SERVER_DHOHOTV["HOST"],
        converter_port=CONFIG.SOCKET_SERVER_DHOHOTV["PORT"],
        buffer_size=CONFIG.SOCKET_SERVER_DHOHOTV["BUFFER_SIZE"],
