...
class Ops:
    ...
    def generate_send_chart(self, data:dict) -> None:
        ...
        fig.suptitle("SERVER REMOTE 2", weight='bold', fontsize=16)
        # update margin 
        ...
        color = "black"
        if data[key_data[12]]["total_video_last_hour"] < 6:
            color = "red"
            ax13.spines['bottom'].set_color('red')
            ax13.spines['top'].set_color('red')
            ax13.spines['right'].set_color('red')
            ax13.spines['left'].set_color('red')
        ...
        color = "black"
        if data[key_data[13]]["total_video_last_hour"] < 6:
            color = "red"
            ax14.spines['bottom'].set_color('red')
            ax14.spines['top'].set_color('red')
            ax14.spines['right'].set_color('red')
            ax14.spines['left'].set_color('red')
        ax14.text(0.5, 0.6, 'CHANNEL', ha='center', va='center', fontsize=10, weight='bold')
        ax14.text(0.5, 0.5, key_data[13], ha='center', va='center', fontsize=16, weight='bold', color=color)
        ax14.text(0.5, 0.4, 'LAST VIDEO', ha='center', va='center', fontsize=10, weight='bold')
        ax14.text(0.5, 0.3, data[key_data[13]]["last_video_filename"], ha='center', va='center', fontsize=10, weight='bold')
        ax14.set_xticks([])
        ax14.set_yticks([])

        ax15 = fig.add_subplot(gs[2, 4])
        color = "black"
        if data[key_data[14]]["total_video_last_hour"] < 6:
            color = "red"
            ax15.spines['bottom'].set_color('red')
            ax15.spines['top'].set_color('red')
            ax15.spines['right'].set_color('red')
            ax15.spines['left'].set_color('red')
        ax15.text(0.5, 0.6, 'CHANNEL', ha='center', va='center', fontsize=10, weight='bold')
        ax15.text(0.5, 0.5, key_data[14], ha='center', va='center', fontsize=16, weight='bold', color=color)
        ax15.text(0.5, 0.4, 'LAST VIDEO', ha='center', va='center', fontsize=10, weight='bold')
        ax15.text(0.5, 0.3, data[key_data[14]]["last_video_filename"], ha='center', va='center', fontsize=10, weight='bold')
        ax15.set_xticks([])
        ax15.set_yticks([])

        total_video = [data[key_data[0]]["total_video"], data[key_data[1]]["total_video"], data[key_data[2]]["total_video"], data[key_data[3]]["total_video"], data[key_data[4]]["total_video"], data[key_data[5]]["total_video"], data[key_data[6]]["total_video"], data[key_data[7]]["total_video"], data[key_data[8]]["total_video"], data[key_data[9]]["total_video"], data[key_data[10]]["total_video"], data[key_data[11]]["total_video"], data[key_data[12]]["total_video"], data[key_data[13]]["total_video"], data[key_data[14]]["total_video"]]
        labels = [key_data[0], key_data[1], key_data[2], key_data[3], key_data[4], key_data[5], key_data[6], key_data[7],  key_data[8], key_data[9],key_data[10],key_data[11],key_data[12],key_data[13],key_data[14]]
